...
try {
  ...
  await page.goto("http://127.0.0.1:8143/x3dom-spikes/spike-x3dom-inline-gltf-probe.html", { waitUntil: "networkidle0", timeout: 30000 });
  try {
    await page.waitForFunction(() => window.__testResult != null, { timeout: 20000 });
  } catch (waitErr) {
