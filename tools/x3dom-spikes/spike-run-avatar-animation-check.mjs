...
try {
  ...
  await page.goto("http://127.0.0.1:8143/x3dom-spikes/spike-x3dom-avatar-animation-check.html", { waitUntil: "networkidle0", timeout: 30000 });
  await page.waitForFunction(() => window.__testResult != null, { timeout: 30000 }).catch(() => {});
  ...
  console.log("LOG:\n" + logText);
  await page.screenshot({ path: join(OUT_DIR, "avatar-animation-check.png") });
